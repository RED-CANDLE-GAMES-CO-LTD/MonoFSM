...
namespace RCGMaker.Core.DataProvider
{
    ...
    {
        protected override AbstractMonoVariable ListenToVariable => variableProvider.VarRaw;
        public override Object targetObject => variableProvider?.VarRaw;
        public override Type targetType => variableProvider.GetValueType;
