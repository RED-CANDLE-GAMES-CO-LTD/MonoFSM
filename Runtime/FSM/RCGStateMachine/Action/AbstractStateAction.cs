...
namespace RCGMaker.Core
{
    public abstract class AbstractStateAction : AbstractBehaviour
    {
        ...
        {
            get { return conditions.IsAllValid(); }
        }
        ...
        [Component(typeof(AbstractConditionNode), AddComponentAt.Children, "[Condition]")]
        // #endif
        [AutoChildren(false, DepthOneOnly = true)]
        public AbstractConditionNode[] conditions; //condition 成立，才能做事
